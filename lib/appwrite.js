import {Client, Account, Databases, ID, Storage, Query, Functions } from 'appwrite'
...
export const COLLECTIONS = {
    ...
    SAVED_EVENTS: config.appwrite.collections.savedEvents,
    REPORTS: config.appwrite.collections.reports,
    BLOCKED_USERS: config.appwrite.collections.blockedUsers,
    NOTIFICATION_PREFERENCES: config.appwrite.collections.notificationPreferences,
}
...
export const EVENT_TYPE_LABELS = {
    ...
    [EVENT_TYPES.FOOD_TRUCK]: 'Food Truck',
...
export const EVENT_TYPE_ICONS = {
    ...
    [EVENT_TYPES.FOOD_TRUCK]: 'fast-food-outline',
